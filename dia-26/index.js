...
Como socio te sale a: 154.6848799999999994 
...
const deboSerSocio=(veces)=>{
    ...
    let resultado = `Como usuario casual te sale: ${llenadoIndividual}\n`
    resultado += `Como socio te sale: ${parseFloat(llenadoSocio.toFixed(2))}\n`
